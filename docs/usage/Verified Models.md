...
| `deepinfra/qwen/qwen3-14b` | $0.12 | $0.24 | unknown | `system` | ⚠ | `reasoning_budget` |
...
| `deepinfra/qwen/qwen3-30b-a3b` | $0.12 | $0.50 | unknown | `system` | ⚠ | `reasoning_budget` |
| `deepinfra/qwen/qwen3-32b` | $0.08 | $0.28 | unknown | `system` | ⚠ | `reasoning_budget` |
...
| `gemini/gemini-3-pro-image` | $2.00 | $12.00 | 2026-05-28 | `prefill` | ✓ | `reasoning_budget` |
...
| `novita/deepseek/deepseek-v4-flash-0731` | $0.44 | $1.32 | unknown | `system` | ⚠ | `reasoning_budget` |
...
| `novita/minimax/minimax-m2.7-highspeed` | $0.60 | $2.40 | unknown | `system` | ⚠ | `reasoning_budget` |
...
| `novita/moonshotai/kimi-k3` | $3.00 | $15.00 | unknown | `prefill` | ⚠ | `reasoning_budget` |
...
| `openai/gpt-5.5-pro-2026-04-23` | $30.00 | $180.00 | unknown | `system` | ⚠ | `no_temperature`, `reasoning_budget` |
