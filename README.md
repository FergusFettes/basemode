...
The registry currently contains 314 model endpoints with a tested prompt strategy. The [full model table](https://fergusfettes.github.io/basemode/usage/Verified-Models/) lists prices, release dates, strategies, and compatibility quirks. It is generated from the same registry used at runtime.
